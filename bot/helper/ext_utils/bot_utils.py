...
async def get_stats(event, key="home"):
    ...
    if key == "home":
        ...
        official_v = (await cmd_exec("curl -o latestversion.py https://github.com/TOICTONY/wzml-2/-/raw/hk_wzmlx/bot/version.py -s && python3 latestversion.py && rm latestversion.py", True))[0]
